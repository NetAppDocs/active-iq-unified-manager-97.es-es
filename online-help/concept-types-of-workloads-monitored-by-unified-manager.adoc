...
+
** Se trata de una copia de protección de datos (DP) en modo de solo lectura. (Tenga en cuenta que los volúmenes de DP se supervisan para ver el tráfico generado por el usuario).
