...
sidebar: sidebar 
keywords:  
summary: Puede crear un informe que contenga la lista de volúmenes que se esté acercando a su capacidad completa con la función Snapshot Autodelete deshabilitada. Los resultados pueden ayudar a identificar volúmenes en los que puede que desee configurar la eliminación automática de instantánea. 
---
...
[role="lead"]
Puede crear un informe que contenga la lista de volúmenes que se esté acercando a su capacidad completa con la función Snapshot Autodelete deshabilitada. Los resultados pueden ayudar a identificar volúmenes en los que puede que desee configurar la eliminación automática de instantánea.
