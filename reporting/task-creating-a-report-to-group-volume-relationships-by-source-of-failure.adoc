...
Use los siguientes pasos para crear una vista personalizada que agrupe volúmenes por origen de un error y, a continuación, programe un informe que se genere para esa vista.
...
. Guarde la vista con un nombre específico que refleje lo que se muestra en la vista, por ejemplo "'Relaciones de vol por fallo'".
