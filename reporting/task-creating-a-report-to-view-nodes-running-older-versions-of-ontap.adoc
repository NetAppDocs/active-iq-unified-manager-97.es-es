...
. Guarde la vista con un nombre específico que refleje lo que se muestra en la vista, por ejemplo «'Nodes by ONTAP version'».
...
Según los resultados que se muestran en el informe, quizás desee actualizar nodos con versiones de ONTAP anteriores.
