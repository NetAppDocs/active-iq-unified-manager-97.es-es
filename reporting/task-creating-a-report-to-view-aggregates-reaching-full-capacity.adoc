...
Utilice los siguientes pasos para crear una vista personalizada donde se muestren los agregados que alcanzan su capacidad completa y, a continuación, se programa la generación de un informe para esa vista.
...
. Guarde la vista con un nombre específico que refleje lo que se muestra en la vista, por ejemplo, "días a capacidad total de agregado" y haga clic en la Marca de verificación (image:../media/blue-check.gif[""]).
