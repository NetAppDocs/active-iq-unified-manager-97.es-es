...
* *Nivel de cloud*
+
Muestra la capacidad utilizada para todos los niveles de cloud conectados de agregados habilitados para FabricPool en el clúster. Un FabricPool puede tener licencia o no tener licencia.
