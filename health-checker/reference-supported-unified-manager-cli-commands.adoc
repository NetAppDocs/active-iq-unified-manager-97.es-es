...
`um svm list [-q] [ -ObjectType <object-id>]`
 a| 
Enumera las SVM después de filtrar en el objeto especificado. El tipo de objeto puede ser lun, qtree, clúster, volumen, cuota, o svm. Por ejemplo: `um svm list -cluster 1`
